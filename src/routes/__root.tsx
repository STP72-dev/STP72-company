...
import { DEFAULT_LOCALE, LOCALES, siteConfig } from "@/config/site";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${siteConfig.brand} — ${siteConfig.descriptor.en}` },

      { name: "description", content: getContent("en").meta.home.description },

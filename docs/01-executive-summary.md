...
* **Evidence-Based Engineering**: The platform never quotes fabricated metrics or anonymous client testimonials. Instead, it anchors capabilities to verifiable public engineering repositories, reference architectures, prototypes, and demonstrators (see [`src/config/site.ts:L30-33`](file:///home/w7-loqker/w7-workspace/selfbase/@stp72.com/repos/STP72-company/src/config/site.ts#L30-L33)).
...
* **Radical AI Transparency**: Every AI-driven capability includes explicit verification rules, boundary conditions, and human-in-the-loop approval requirements (embodied in [`src/components/ds/AILabel.tsx:L1-93`](file:///home/w7-loqker/w7-workspace/selfbase/@stp72.com/repos/STP72-company/src/components/ds/AILabel.tsx#L1-L93)).
...
```
/home/w7-loqker/w7-workspace/selfbase/@stp72.com/repos/STP72-company/
├── src/
